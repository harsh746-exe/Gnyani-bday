...
function creatMountainRange(mountainAmount, color){
...
backgroundGradient.addColorStop(0, '#1C1534')
backgroundGradient.addColorStop(1, '#1C1534 ')
...
// Usage example
const mountainImageSrc = 'C:\Users\Samarcade\Downloads\First-Anniversary-of-Love-gh-pages\First-Anniversary-of-Love-gh-pages\pic\pic4.png'; // Replace with the actual path to your image
drawImageOnCanvas(mountainImageSrc, 0, canvas.height - groundHeight, canvas.width, groundHeight);
// Animation Loop
function animate() {
